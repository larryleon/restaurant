...
public class MainS extends JFrame implements ActionListener,
	...
	private JTextField orderID, subTotal, customerID, detuct, status_menu,
			price_menu, itemID_menu, name_menu;
	private JTextField phone, street, apt, zip, grandTotal, un6;
	private JTable restaurantTable, saleTable, menuTable, menuTable_menu,
			restaurantTable_Res, customerTable_cus;
	private TModel menuModel, saleModel;
	private TModel restaurantTableModel, menuTable_menuModel,
			restaurantTable_ResModel, customerTable_cusModel;

	private JTextField newCatagory_menu, lastName, city, firstName, zip_Res,
			customerID_Res, businessName_Res, cellPhone_Res;
	private JTextField phone3_Res, abName_Res, lastName_Res, street_Res,
			unit_Res, city_Res, phone_Res, firstName_Res, total_cus;
	...
	private JButton update_menu, add_menu, delete_menu, catagoryAdd_menu,
			catagoryDelete_menu, capture_menu;
	...
	private DefaultListModel catagoryEditor_menuModel, restaurantModel,
			catagoryModel;
	...
	private void initial() {
		...
		String[] columnNames = new String[] { "ItemID", "Name", "Price", "Hot",
				"Catagory", "Note" };
		boolean[] edit = new boolean[] { false, false, false, false, false,
				false };
		...
		columnNames = new String[] { "ID", "First Name", "Last Name", "Street",
				"Apt", "City", "State", "Zip", "Phone" };
		...
		columnNames = new String[] { "ID", "Name", "City", "State", "Zip",
				"Phone", "ABName", "First Name", "Last Name" };
		edit = new boolean[] { false, false, false, false, false, false, false,
				false, false };
		...
		columnNames = new String[] { "ItemID", "Name", "Price", "Hot",
				"Catagory", "Status" };
		...
		columnNames = new String[] { "First Name", "Last Name", "Position",
				"Experience" };
	...
	public MainS() {
		...
		try {
			...
			try {
				...
				System.err
						.println("ComputeEngine exception: " + e.getMessage());
				e.printStackTrace();
			}
			P.p("OK");
		} catch (Exception e) {
	...
	private void jbInit() throws Exception {
		...
		videoWindow.setBorder(BorderFactory.createLineBorder(new Color(146,
				179, 171), 1));
		...
		jPanel5.setBorder(BorderFactory.createLineBorder(new Color(143, 138,
				179), 1));
		jPanel3.setBorder(BorderFactory.createLineBorder(new Color(153, 155,
				179), 1));
		jPanel3.setLayout(gridBagLayout3);
		jLabel4.setText("SubTotal$:");
		jLabel4.setHorizontalAlignment(SwingConstants.TRAILING);
		subTotal.setBorder(BorderFactory.createLineBorder(
				new Color(179, 6, 165), 1));
		saleDelete.setText("--");
		downPane.setBorder(BorderFactory.createLineBorder(new Color(146, 179,
				171), 1));
		...
		dishPicture.setBorder(BorderFactory.createLineBorder(new Color(143,
				179, 149), 1));
		detuct.setText("0");
		...
		jPanel5.add(jPanel8, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						5, 5, 3, 0), 5, 12));
		jPanel5.add(jPanel9, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						5, 0, 3, 3), 0, 0));
		jPanel3.add(delivery, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						5, 15, 0, 0), 10, 2));
		jPanel3.add(goOrStay, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						5, 0, 0, 0), 32, 2));
		jPanel3.add(saleConfirm, new GridBagConstraints(0, 3, 2, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						30, 5, 0, 0), 16, 2));
		jScrollPane4.getViewport().add(saleTable, null);
		jPanel3.add(jScrollPane4, new GridBagConstraints(2, 1, 3, 4, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						0, 0, 3, 3), -262, -282));
		jPanel3.add(subTotal, new GridBagConstraints(0, 2, 2, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(0, 5, 0, 0), 83, 9));
		jPanel3.add(jLabel4, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0,
						5, 0, 0), 18, 6));
		jPanel8.add(jLabel2, new GridBagConstraints(2, 4, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(
						13, 15, 0, 0), 5, 6));
		jPanel8.add(PL, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5,
						0, 0, 0), 11, 1));
		jPanel8.add(phone, new GridBagConstraints(1, 0, 1, 2, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(5, 0, 0, 0), 16, 4));
		jPanel8.add(jLabellname, new GridBagConstraints(2, 0, 2, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5,
						0, 0, 0), 5, 1));
		jPanel8.add(firstName, new GridBagConstraints(4, 0, 2, 2, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(5, 0, 0, 10), 30, 4));
		jPanel8.add(street, new GridBagConstraints(1, 2, 5, 2, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(12, 0, 0, 10), 191, 4));
		jPanel8.add(phone1, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(
						15, 0, 0, 0), 16, 1));
		jPanel8.add(jLabellname2, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(
						18, 25, 0, 0), 2, 1));
		jPanel8.add(city, new GridBagConstraints(1, 4, 1, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(11, 0, 0, 0), 25, 4));
		jPanel8.add(state, new GridBagConstraints(4, 4, 2, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(11, 0, 0, 10), 86, 5));
		jPanel8.add(customerID, new GridBagConstraints(5, 5, 1, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(15, 10, 0, 10), 84, 6));
		jPanel8.add(jLabellname3, new GridBagConstraints(2, 5, 3, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(
						20, 0, 0, 0), 5, 1));
		jPanel8.add(update, new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						15, 0, 0, 0), 38, 2));
		jPanel9.add(customerIDxx, new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(
						20, 0, 0, 0), 9, 1));
		jPanel9.add(orderID, new GridBagConstraints(1, 6, 2, 2, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(15, 0, 5, 5), 1, 4));
		jPanel9.add(zip, new GridBagConstraints(1, 4, 2, 2, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(15, 0, 0, 5), 10, 6));
		jPanel9.add(jLabel3, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(
						18, 25, 0, 0), 12, 1));
		jPanel9.add(apt, new GridBagConstraints(1, 2, 2, 2, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(15, 0, 0, 5), 10, 4));
		jPanel9.add(jLabellname1, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(
						17, 15, 0, 0), 17, 1));
		jPanel9.add(lastName, new GridBagConstraints(1, 0, 2, 2, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(5, 0, 0, 5), 10, 6));
		jPanel9.add(jLabel1, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5,
						0, 0, 0), 3, 1));
		jPanel10.add(videoWindow, new GridBagConstraints(7, 0, 1, 3, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						5, 0, 0, 5), 133, 153));
		jPanel10.add(grandTotal, new GridBagConstraints(5, 2, 1, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(0, 10, 0, 0), 73, 9));
		jPanel10.add(jLabel6, new GridBagConstraints(3, 2, 2, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(
						10, 25, 0, 0), 8, 6));
		jPanel10.add(detuct, new GridBagConstraints(1, 2, 2, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(10, 0, 0, 0), 33, 6));
		jPanel10.add(jLabel5, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(
						10, 5, 0, 0), 13, 11));
		jScrollPane2.getViewport().add(customer, null);
		jPanel10.add(jScrollPane2, new GridBagConstraints(0, 0, 7, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						5, 5, 0, 0), 22, -30));
		jPanel10.add(phoneContact, new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						10, 15, 0, 0), 15, -3));
		jPanel10.add(outsideCustomer, new GridBagConstraints(3, 1, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(10, 0, 0, 0), 17, -3));
		jPanel10.add(insideCustomer, new GridBagConstraints(5, 1, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(10, 10, 0, 0), 20, -3));
		jScrollPane3.getViewport().add(restaurantTable, null);
		jPanel6.add(jScrollPane3, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						5, 5, 5, 0), -242, -247));
		jScrollPane1.getViewport().add(restaurant, null);
		jPanel6.add(jScrollPane1, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						5, 0, 5, 0), -93, 25));
		jPanel6.add(jPanel3, new GridBagConstraints(2, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						5, 0, 5, 0), 5, 0));
		jScrollPane5.getViewport().add(important, null);
		jPanel6.add(jScrollPane5, new GridBagConstraints(3, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						5, 15, 5, 5), 226, 133));
		jScrollPane8.getViewport().add(dishDescrption, null);
		jPanel2.add(jScrollPane8, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						0, 0, 0, 10), 136, 103));
		jScrollPane9.getViewport().add(dishPicture, null);
		jPanel2.add(jScrollPane9, new GridBagConstraints(1, 1, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						0, 0, 0, 10), 124, 84));
		jScrollPane7.getViewport().add(catagory, null);
		jPanel2.add(jScrollPane7, new GridBagConstraints(0, 0, 1, 3, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						0, 5, 0, 0), -183, 110));
		downPane.add(jPanel2, new GridBagConstraints(2, 0, 1, 3, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						5, 0, 3, 3), 0, 0));
		jScrollPane6.getViewport().add(menuTable, null);
		downPane.add(jScrollPane6, new GridBagConstraints(0, 0, 1, 3, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						5, 5, 3, 0), 198, -162));
		downPane.add(saleAdd, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						45, 0, 0, 0), -1, 27));
		downPane.add(saleDelete, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						65, 0, 0, 0), -1, 27));
		jScrollPane12.getViewport().add(jPanel10, null);
		upPane.add(jScrollPane12, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						0, 0, 0, 15), -37, -7));
		jScrollPane10.getViewport().add(jPanel5, null);
		upPane.add(jScrollPane10, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						0, 0, 0, 0), -2, 3));
		jScrollPane11.getViewport().add(jPanel6, null);
		upPane.add(jScrollPane11, new GridBagConstraints(0, 1, 2, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						0, 0, 5, 15), -4, 31));
	...
	private void creatMenuPane() {
		...
		jPanel5_menu.setBorder(BorderFactory.createLineBorder(new Color(143,
				138, 179), 1));
		menuTable_menu.setBorder(BorderFactory.createLineBorder(new Color(179,
				41, 90), 1));
		...
		jPanel1_menu.setBorder(BorderFactory.createLineBorder(new Color(143,
				138, 179), 1));
		jPanel2_menu.setLayout(gridBagLayout1);
		jPanel3_menu.setLayout(gridBagLayout2);
		jPanel5_menu.add(jPanel3_menu, new GridBagConstraints(0, 0, 1, 1, 1.0,
				1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(5, 15, 0, 0), 0, -5));
		jPanel5_menu.add(jPanel1_menu, new GridBagConstraints(1, 0, 1, 1, 1.0,
				1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(5, 0, 0, 0), -26, -34));
		jPanel5_menu.add(jPanel2_menu, new GridBagConstraints(2, 0, 1, 1, 1.0,
				1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(5, 10, 0, 6), 0, 0));
		jPanel1_menu.add(catagoryAdd_menu, new GridBagConstraints(1, 2, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(0, 0, 5, 10), 19, 2));
		jPanel1_menu.add(catagoryDelete_menu, new GridBagConstraints(0, 2, 1,
				1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(0, 5, 5, 0), 7, 2));
		jPanel1_menu
				.add(newCatagory_menu, new GridBagConstraints(0, 1, 2, 1, 1.0,
						0.0, GridBagConstraints.WEST,
						GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0, 10),
						129, 6));
		jScrollPane1_menu.getViewport().add(catagoryEditor_menu, null);
		jPanel1_menu.add(jScrollPane1_menu, new GridBagConstraints(0, 0, 2, 1,
				1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(5, 5, 0, 10), -118, -50));
		jPanel2_menu.add(delete_menu, new GridBagConstraints(2, 3, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(20, 20, 0, 0), 12, 2));
		jPanel2_menu.add(capture_menu, new GridBagConstraints(3, 0, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(5, 25, 0, 0), 4, -3));
		jPanel2_menu.add(jScrollPane3_menu, new GridBagConstraints(3, 3, 2, 2,
				1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(0, 10, 5, 5), 103, 93));
		jPanel2_menu.add(add_menu, new GridBagConstraints(2, 4, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						25, 20, 5, 0), 24, 2));
		jPanel2_menu.add(update_menu, new GridBagConstraints(2, 0, 1, 3, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(5, 20, 0, 0), 8, 2));
		jPanel2_menu.add(desc_menu, new GridBagConstraints(0, 0, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 10, 0, 0), 23, 1));
		jScrollPane2_menu.getViewport().add(description_menu, null);
		jPanel2_menu.add(jScrollPane2_menu, new GridBagConstraints(0, 3, 2, 2,
				1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(0, 10, 5, 0), 96, 73));
		jPanel3_menu.add(jLabel2_menu, new GridBagConstraints(3, 2, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(35, 15, 0, 0), 19, 6));
		jPanel3_menu.add(hot_menu, new GridBagConstraints(5, 4, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						20, 0, 0, 0), 52, -3));
		jPanel3_menu.add(status_menu, new GridBagConstraints(5, 2, 2, 2, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(35, 0, 0, 0), 21, 4));
		jPanel3_menu.add(catagory_menu, new GridBagConstraints(5, 0, 2, 1, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(0, 0, 0, 0), 86, 5));
		jPanel3_menu.add(jLabel1_menu, new GridBagConstraints(3, 0, 2, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(0, 10, 0, 0), 15, 1));
		jPanel3_menu.add(itemID_menu, new GridBagConstraints(1, 0, 2, 1, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(0, 0, 0, 0), 99, 6));
		jPanel3_menu.add(jLabellname3menu, new GridBagConstraints(0, 0, 1, 1,
				0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(0, 5, 0, 0), 14, 1));
		jPanel3_menu.add(name_menu, new GridBagConstraints(1, 2, 2, 2, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(35, 0, 0, 0), 99, 6));
		jPanel3_menu.add(jLabel4_menu, new GridBagConstraints(0, 2, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(35, 5, 0, 0), 23, 6));
		jPanel3_menu.add(price_menu, new GridBagConstraints(1, 4, 2, 2, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(20, 0, 10, 0), 30, 4));
		jPanel3_menu.add(jLabel_menu, new GridBagConstraints(0, 4, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(25, 5, 0, 0), 22, 1));
	...
	private void createRestaurantPane() {
		...
		jPanel5_Res.setBorder(BorderFactory.createLineBorder(new Color(143,
				138, 179), 1));
		restaurantTable_Res.setBorder(BorderFactory.createLineBorder(new Color(
				179, 41, 90), 1));
		...
		jPanel5_Res.add(abName_Res, new GridBagConstraints(16, 3, 1, 2, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(25, 0, 0, 3), 74, 6));
		jPanel5_Res.add(phone3_Res, new GridBagConstraints(16, 0, 1, 2, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(10, 0, 0, 3), 74, 6));
		jPanel5_Res.add(jLabel6_Res, new GridBagConstraints(15, 3, 1, 2, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(25, 0, 0, 0), 9, 6));
		jPanel5_Res.add(jLabel5_Res, new GridBagConstraints(15, 0, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(10, 0, 0, 0), 9, 1));
		jPanel5_Res.add(delete_Res, new GridBagConstraints(16, 6, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(20, 0, 0, 3), 22, 2));
		jPanel5_Res.add(add_Res, new GridBagConstraints(14, 6, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						20, 0, 0, 0), 34, 2));
		jPanel5_Res
				.add(businessName_Res, new GridBagConstraints(4, 0, 4, 2, 1.0,
						0.0, GridBagConstraints.WEST,
						GridBagConstraints.HORIZONTAL, new Insets(10, 0, 0, 0),
						149, 6));
		jPanel5_Res.add(jLabel4_Res, new GridBagConstraints(2, 0, 2, 2, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(10, 0, 0, 0), 23, 6));
		jPanel5_Res.add(customerID_Res, new GridBagConstraints(1, 0, 1, 2, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(10, 0, 0, 0), 94, 6));
		jPanel5_Res.add(firstName_Res, new GridBagConstraints(12, 0, 1, 2, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(10, 0, 0, 0), 15, 4));
		jPanel5_Res.add(jLabel1_Res, new GridBagConstraints(13, 0, 1, 2, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(10, 10, 0, 0), 15, 1));
		jPanel5_Res.add(jLabellname_Res, new GridBagConstraints(8, 0, 3, 1,
				0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(10, 15, 0, 0), 15, 1));
		jPanel5_Res.add(lastName_Res, new GridBagConstraints(14, 0, 1, 2, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(10, 0, 0, 0), 5, 6));
		jPanel5_Res.add(phone_Res, new GridBagConstraints(12, 3, 1, 2, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(25, 0, 0, 0), 6, 4));
		jPanel5_Res.add(jLabel_Res, new GridBagConstraints(10, 3, 2, 2, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(30, 0, 0, 0), 6, 1));
		jPanel5_Res.add(street_Res, new GridBagConstraints(1, 3, 4, 2, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(25, 0, 0, 0), 186, 4));
		jPanel5_Res.add(unit_Res, new GridBagConstraints(7, 3, 2, 2, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(25, 0, 0, 0), -5, 4));
		jPanel5_Res.add(jLabellname1_Res, new GridBagConstraints(5, 3, 2, 1,
				0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(25, 15, 0, 0), 17, 1));
		jPanel5_Res.add(jLabelll_Res, new GridBagConstraints(0, 3, 1, 2, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(30, 20, 0, 0), 21, 1));
		jPanel5_Res.add(jLabel2_Res, new GridBagConstraints(2, 6, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(25, 30, 0, 0), 5, 6));
		jPanel5_Res.add(jLabel3_Res, new GridBagConstraints(5, 6, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(25, 15, 0, 0), 12, 1));
		jPanel5_Res.add(zip_Res, new GridBagConstraints(7, 6, 3, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(20, 0, 0, 0), 5, 6));
		jPanel5_Res.add(state_Res, new GridBagConstraints(3, 6, 2, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(20, 0, 0, 0), 76, 5));
		jPanel5_Res.add(city_Res, new GridBagConstraints(1, 6, 1, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(20, 0, 0, 0), 25, 4));
		jPanel5_Res.add(jLabelln_Res, new GridBagConstraints(0, 6, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(25, 50, 0, 0), 2, 1));
		jPanel5_Res.add(jLabell_Res, new GridBagConstraints(0, 0, 1, 2, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(10, 5, 0, 0), 10, 1));
		jPanel5_Res.add(cellPhone_Res, new GridBagConstraints(14, 3, 1, 2, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(25, 0, 0, 0), -4, 4));
		jPanel5_Res.add(customerIDxx_Res, new GridBagConstraints(13, 3, 1, 2,
				0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(30, 25, 0, 0), 3, 1));
		jPanel5_Res.add(update_Res, new GridBagConstraints(12, 6, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(20, 0, 0, 0), 28, 2));
	...
	private void createCustomerPane() {
		...
		control_cus.add(total_cus, new GridBagConstraints(7, 0, 1, 1, 1.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(5, 10, 10, 125), 74, 6));
		control_cus.add(jLabel13_cus, new GridBagConstraints(6, 0, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 0, 10, 0), 16, 11));
		control_cus.add(jLabel1_cus1, new GridBagConstraints(4, 0, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 0, 10, 0), 21, 11));
		control_cus.add(customerID_cus, new GridBagConstraints(5, 0, 1, 1, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(5, 0, 10, 0), 161, 5));
		control_cus.add(saleRecord_cus, new GridBagConstraints(3, 0, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(5, 10, 10, 0), 11, 2));
		control_cus.add(customerList_cus, new GridBagConstraints(2, 0, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(5, 0, 10, 0), 12, 2));
		control_cus.add(jLabel1_cus, new GridBagConstraints(0, 0, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 10, 0), 8, 11));
		control_cus.add(restaurantID_cus, new GridBagConstraints(1, 0, 1, 1,
				1.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.HORIZONTAL, new Insets(5, 0, 10, 0), 71, 5));
	...
	private void saleRecord_cusOp() {
		...
		if (type.equalsIgnoreCase("ALL"))
			temdata = Database.getSaleRecords((String) (resID.get(index)),
					null, null);
		else
			temdata = Database.getSaleRecords((String) (resID.get(index)),
					type, null);

		String[] names = new String[] { "First Name", "Last Name", "Name",
				"Price", "DateSold", "TRNO" };
	...
	private void customerList_cusOp() {
		...
		String[] names = new String[] { "ID", "First Name", "Last Name",
	...
	private void restaurantID_cusOp() {
		int index = restaurantID_cus.getSelectedIndex();
		Vector temdata = Database.getCustomers((String) (resID.get(index)),
				null);
	...
	private void saleConfirmOp() {
		...
		String orID = "";
		if ((orID = Database.addTransactions(temdata, RESTAURANTID, customerID
				.getText().trim())).equalsIgnoreCase("-1")) {
	...
	private void saleAddOp() {
		...
		grandTotal.setText(""
				+ (subT - Double.parseDouble(detuct.getText().trim())));
	...
	private void updateOp() {
		...
		ss[4] = street.getText().trim();
		ss[5] = apt.getText().trim();
		ss[6] = city.getText().trim();
		ss[7] = state.getSelectedItem().toString().trim();
		ss[8] = zip.getText().trim();
		ss[9] = phone.getText().trim();
	...
	private void update_ResOp() {
		...
		String[] ss = new String[13];
		String[] ssT = (String[]) (restaurantTable_ResModel.getData()
				.get(index));
		ss[0] = ssT[0];
		ss[1] = businessName_Res.getText().trim();
		ss[2] = street_Res.getText().trim();
	...
	private void delete_ResOp() {
		...
		if (index.length <= 0) {
			JOptionPane.showMessageDialog(null,
					"Please Select rows in the Table!!!");
			return;
		}
	...
	private void catagoryDelete_menuOp() {
		...
		if (index < 0) {
			JOptionPane
					.showMessageDialog(null, "Select Restaurant Table first");
			return;
		}
		String resid = (String) (restaurantTable_Res.getValueAt(index, 0));
	...
	private void delete_menuOp() {
		...
		if (index.length <= 0) {
			JOptionPane.showMessageDialog(null,
					"Please Select rows in the menuTable_menu");
			return;
		}
		String[] itemids = new String[index.length];
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		if (o != restaurant) {
			...
			if (lsm.isSelectionEmpty()) {
				...
				if (lsm == lsm_Res) {
					String id = (String) (restaurantTable_Res.getValueAt(
							selectedRow, 0));
				...
				if (lsm == lsm_menu) {
					String itemid = (String) (menuTable_menu.getValueAt(
							selectedRow, 0));
					int resIndex = restaurantTable_Res.getSelectedRow();
					String resid = (String) (restaurantTable_Res.getValueAt(
							resIndex, 0));
				...
				if (lsm == lsm_cus) {
					if (customerTable_cusModel.getID().equalsIgnoreCase(
							"SaleRecord")) {
						int[] inds = customerTable_cus.getSelectedRows();
						double t = 0;
						for (int i = 0; i < inds.length; i++) {
							t = t
									+ Double.parseDouble((String) (customerTable_cus
											.getValueAt(inds[i], 3)));
						}
						total_cus.setText("" + t);
					}
