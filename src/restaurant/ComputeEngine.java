                           ...
                           implements Compute
{
    ...
    public void phoneRing(String resid,String phoneno,String firstname,String lastname,String midname)
    {
    }
      ...
      for(int i=0;i<tem.size();i++)
      {
          ...
          }else
          {
            ...
            for(int j=0;j<data.size();j++)
            {
              ...
              {
                ss0[1]=""+(Double.parseDouble(ss0[1])+Double.parseDouble(ss1[1]));
                same=true;
                break;
              }
            }
 ...
 /**
    public static void main(String[] args) {
        ...
        try {
            Compute engine = new ComputeEngine(new MainS());
            p.p(name);
